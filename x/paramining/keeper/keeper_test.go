...
import (
	...
	keeper2 "github.com/ouroboros-crypto/node/x/emission/keeper"
	...
	paramining "github.com/ouroboros-crypto/node/x/paramining/keeper"
	"github.com/ouroboros-crypto/node/x/paramining/types"
...
var (
	initCoins     = sdk.NewCoins(ouroTypes.NewOuroCoin(10000000000))
)
...
func TestGetDailyPercent(t *testing.T) {
	...
	assert.True(t, sdk.NewInt(6).Equal(types.GetDailyPercent(sdk.NewIntWithDecimal(67, ouroTypes.POINTS)))) // 67
	assert.True(t, sdk.NewInt(6).Equal(types.GetDailyPercent(sdk.NewInt(99999999)))) // 99.999999

	// 100 => 999 - 0.07%
	assert.True(t, sdk.NewInt(7).Equal(types.GetDailyPercent(sdk.NewIntWithDecimal(100, ouroTypes.POINTS)))) // 100
	assert.True(t, sdk.NewInt(7).Equal(types.GetDailyPercent(sdk.NewIntWithDecimal(764, ouroTypes.POINTS)))) // 764
	assert.True(t, sdk.NewInt(7).Equal(types.GetDailyPercent(sdk.NewInt(999999999)))) // 999.999999

	// 1000 => 9999 - 0.09%
	assert.True(t, sdk.NewInt(9).Equal(types.GetDailyPercent(sdk.NewIntWithDecimal(1000, ouroTypes.POINTS)))) // 1000
	assert.True(t, sdk.NewInt(9).Equal(types.GetDailyPercent(sdk.NewIntWithDecimal(5432, ouroTypes.POINTS)))) // 5432
	assert.True(t, sdk.NewInt(9).Equal(types.GetDailyPercent(sdk.NewInt(9999999999)))) // 9999.999999

	// 10.000 => 49.999 - 0.1%
	assert.True(t, sdk.NewInt(10).Equal(types.GetDailyPercent(sdk.NewIntWithDecimal(10000, ouroTypes.POINTS)))) // 10k
	assert.True(t, sdk.NewInt(10).Equal(types.GetDailyPercent(sdk.NewIntWithDecimal(15873, ouroTypes.POINTS)))) // 15.873k
	assert.True(t, sdk.NewInt(10).Equal(types.GetDailyPercent(sdk.NewInt(49999999999)))) // 49.999k

	// 50.000 => 99.999 - 0.12%
	assert.True(t, sdk.NewInt(12).Equal(types.GetDailyPercent(sdk.NewIntWithDecimal(50000, ouroTypes.POINTS)))) // 50k
	assert.True(t, sdk.NewInt(12).Equal(types.GetDailyPercent(sdk.NewIntWithDecimal(65783, ouroTypes.POINTS)))) // 65.783k
	assert.True(t, sdk.NewInt(12).Equal(types.GetDailyPercent(sdk.NewInt(99999999999)))) // 99.999k

	// 100.000 => 499.999 - 0.14%
	assert.True(t, sdk.NewInt(14).Equal(types.GetDailyPercent(sdk.NewIntWithDecimal(100000, ouroTypes.POINTS)))) // 100k
	assert.True(t, sdk.NewInt(14).Equal(types.GetDailyPercent(sdk.NewIntWithDecimal(356784, ouroTypes.POINTS)))) // 356.784k
	assert.True(t, sdk.NewInt(14).Equal(types.GetDailyPercent(sdk.NewInt(499999999999)))) // 499.999k

	// 500.000 => 2.000.000 - 0.16%
	assert.True(t, sdk.NewInt(16).Equal(types.GetDailyPercent(sdk.NewIntWithDecimal(500000, ouroTypes.POINTS)))) // 500k
	assert.True(t, sdk.NewInt(16).Equal(types.GetDailyPercent(sdk.NewIntWithDecimal(1874659, ouroTypes.POINTS)))) // 1.874kk
	assert.True(t, sdk.NewInt(16).Equal(types.GetDailyPercent(sdk.NewIntWithDecimal(2000000, ouroTypes.POINTS)))) // 2kk
}
...
func TestGetStructureCoff(t *testing.T) {
	...
	// 1000-9999 - 2.18
	assert.True(t, sdk.NewInt(218).Equal(types.GetStructureCoff(sdk.NewIntWithDecimal(1000, ouroTypes.POINTS)))) // 1k
	assert.True(t, sdk.NewInt(218).Equal(types.GetStructureCoff(sdk.NewInt(9999999999)))) // 9.999k

	// 10000-99999 - 2.36
	assert.True(t, sdk.NewInt(236).Equal(types.GetStructureCoff(sdk.NewIntWithDecimal(10000, ouroTypes.POINTS)))) // 10k
	assert.True(t, sdk.NewInt(236).Equal(types.GetStructureCoff(sdk.NewInt(99999999999)))) // 99.999k


	// 100000-999999 - 2.77
	assert.True(t, sdk.NewInt(277).Equal(types.GetStructureCoff(sdk.NewIntWithDecimal(100000, ouroTypes.POINTS)))) // 100k
	assert.True(t, sdk.NewInt(277).Equal(types.GetStructureCoff(sdk.NewInt(999999999999)))) // 999.999k


	// 1.000.000-9.999.999 - 3.05
	assert.True(t, sdk.NewInt(305).Equal(types.GetStructureCoff(sdk.NewIntWithDecimal(1000000, ouroTypes.POINTS)))) // 1kkk
	assert.True(t, sdk.NewInt(305).Equal(types.GetStructureCoff(sdk.NewInt(9999999999999)))) // 9.999kk

	// 10.000.000-99.999.999 - 3.36
	assert.True(t, sdk.NewInt(336).Equal(types.GetStructureCoff(sdk.NewIntWithDecimal(10000000, ouroTypes.POINTS)))) // 10k
	assert.True(t, sdk.NewInt(336).Equal(types.GetStructureCoff(sdk.NewInt(99999999999999)))) // 99.999kk

	// 100.000.000-999.999.999 - 3.88
	assert.True(t, sdk.NewInt(388).Equal(types.GetStructureCoff(sdk.NewIntWithDecimal(100000000, ouroTypes.POINTS)))) // 100kk
	assert.True(t, sdk.NewInt(388).Equal(types.GetStructureCoff(sdk.NewInt(999999999999999)))) // 999.999k


	// > 1.000.000.000	- 4.37
	assert.True(t, sdk.NewInt(437).Equal(types.GetStructureCoff(sdk.NewIntWithDecimal(1000000000, ouroTypes.POINTS)))) // 1kkk
	assert.True(t, sdk.NewInt(437).Equal(types.GetStructureCoff(sdk.NewIntWithDecimal(3543000000, ouroTypes.POINTS)))) // 3.54kkk
}
...
func TestCalculateCoinsPerTime(t *testing.T) {
	...
	result := keeper.CalculateCoinsPerTime(ctx, p, sdk.NewInt(0), sdk.NewCoins(sdk.NewCoin(ouroTypes.OURO, coinsAmount)))
	...
	result = keeper.CalculateCoinsPerTime(ctx, p, sdk.NewInt(150), sdk.NewCoins(sdk.NewCoin(ouroTypes.OURO, coinsAmount)))
...
func TestCalculateParamined(t *testing.T) {
	...
	tokens := keeper.CalculateParamined(ctx, p, sdk.NewCoins(sdk.NewCoin(ouroTypes.OURO, coinsAmount)))
