...
import (
	...
	emissionTypes "github.com/ouroboros-crypto/node/x/emission/types"
	ouro "github.com/ouroboros-crypto/node/x/ouroboros"
	"github.com/ouroboros-crypto/node/x/paramining"
	paraminingKeeper "github.com/ouroboros-crypto/node/x/paramining/keeper"
	"github.com/ouroboros-crypto/node/x/structure"
	structureKeeper "github.com/ouroboros-crypto/node/x/structure/keeper"
	"runtime"
)
...
type ouroborosApp struct {
	*bam.BaseApp
	...
	ouroKeeper       ouro.Keeper

	// Module Manager
	mm *module.Manager
}

func NewOuroborosApp(logger log.Logger, db dbm.DB, baseAppOptions ...func(*bam.BaseApp)) *ouroborosApp {
	...
	app.mm = module.NewManager(
		...
		ouro.NewAppModule(app.ouroKeeper, app.bankKeeper),
...
func (app *ouroborosApp) InitChainer(ctx sdk.Context, req abci.RequestInitChain) abci.ResponseInitChain {
...
func (app *ouroborosApp) BeginBlocker(ctx sdk.Context, req abci.RequestBeginBlock) abci.ResponseBeginBlock {
	return app.mm.BeginBlock(ctx, req)
}
func (app *ouroborosApp) EndBlocker(ctx sdk.Context, req abci.RequestEndBlock) abci.ResponseEndBlock {
	return app.mm.EndBlock(ctx, req)
}
func (app *ouroborosApp) LoadHeight(height int64) error {
	return app.LoadVersion(height, app.keyMain)
}

//_________________________________________________________

func (app *ouroborosApp) ExportAppStateAndValidators(forZeroHeight bool, jailWhiteList []string,
